...
volatile uint16_t usart2_rx_len;
volatile uint16_t usart4_rx_len;
volatile uint8_t usart1_flag = 0;
volatile uint8_t usart2_flag = 0;
volatile uint8_t usart4_flag = 0 ;
uint8_t usart1_rx_buf[USART_MAX_DATA_LEN];
uint8_t usart2_rx_buf[USART_MAX_DATA_LEN];
uint8_t usart4_rx_buf[USART_MAX_DATA_LEN];
/* USER CODE END 0 */
